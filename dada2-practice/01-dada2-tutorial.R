...
# 20 known strains was sequenced (this mock community is supposed to be 21 strains,
# but P. acnes is absent from the raw data). Reference sequences corresponding to these
# strains were provided in the downloaded zip archive. We return to that sample and compare
# the sequence variants inferred by DADA2 to the expected composition of the community." -dada2 tutorial
...
# Next step -> community structure visualization tutorial
